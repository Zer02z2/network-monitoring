    ...
    if direction in ("incoming", "outgoing"):
        ...
        for i in range(count):
            ...
            _rects.append({
                ...
                'y': y, 'w': w, 'h': h,
                'rgb': (NEON_RED if random.random() < DIRECTION_COLOR_BIAS else NEON_BLUE) if (color_mode == "CASCADE" and direction == "outgoing") else (NEON_BLUE if random.random() < DIRECTION_COLOR_BIAS else NEON_RED) if color_mode == "CASCADE" else (NEON_RED if direction == "outgoing" else NEON_BLUE),
